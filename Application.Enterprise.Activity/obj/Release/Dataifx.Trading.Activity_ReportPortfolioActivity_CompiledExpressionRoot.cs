namespace Dataifx.Trading.Activity {
    ...
    #line 25 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 26 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    ...
    #line 27 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 28 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 29 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    using System.Text;
    
    #line default
    #line hidden
    
    #line 30 "C:\TFS\TradingSolution\Dataifx.Trading.Activity\ReportPortfolioActivity.xaml"
    ...
    public partial class ReportPortfolioActivity : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((expressionId == 6)) {
                ...
                return refDataContext6.GetLocation<System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport>>(refDataContext6.ValueType___Expr6Get, refDataContext6.ValueType___Expr6Set, expressionId, this.rootActivity, activityContext);
            }
            return null;
        }
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 6)) {
                ...
                return refDataContext6.GetLocation<System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport>>(refDataContext6.ValueType___Expr6Get, refDataContext6.ValueType___Expr6Set);
            }
            return null;
        }
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            ...
            if (((isReference == false) 
                        && ((expressionText == "Business.DetalleInventario.ObtenerValoracionPortafolioClientesComercial(strIdCome" +
                            "rcial)") 
                        && (ReportPortfolioActivity_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 1;
                return true;
            ...
            if (((isReference == false) 
                        && ((expressionText == "Business.Instrumento.ObtenerComportamientoMercado(DateTime.Now , MyUser)") 
                        && (ReportPortfolioActivity_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 3;
                return true;
            }
            ...
            if (((isReference == false) 
                        && ((expressionText == "Business.DetalleInventario.FillPortfolioByTrader(dtMercado,dtPortfolio)") 
                        && (ReportPortfolioActivity_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 5;
                return true;
            }
        ...
        private class ReportPortfolioActivity_TypedDataContext1 : ReportPortfolioActivity_TypedDataContext0 {
            ...
            protected System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> MyPortfolio {
                get {
                    return ((System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport>)(this.GetVariableValue((1 + locationsOffset))));
                }
                set {
            ...
            protected Dataifx.Trading.CommonObjects.InfoUsuario MyUser {
                get {
                    return ((Dataifx.Trading.CommonObjects.InfoUsuario)(this.GetVariableValue((2 + locationsOffset))));
                }
                set {
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 1)].Name != "MyPortfolio") 
                            || (locationReferences[(offset + 1)].Type != typeof(System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport>)))) {
                    return false;
                }
                if (((locationReferences[(offset + 2)].Name != "MyUser") 
                            || (locationReferences[(offset + 2)].Type != typeof(Dataifx.Trading.CommonObjects.InfoUsuario)))) {
                    return false;
                }
        ...
        private class ReportPortfolioActivity_TypedDataContext2 : ReportPortfolioActivity_TypedDataContext1 {
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 68 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr4GetTree() {
                ...
                #line 82 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
                System.Linq.Expressions.Expression<System.Func<System.Data.DataTable>> expression = () => 
                    dtMercado;
            ...
            internal System.Linq.Expressions.Expression @__Expr6GetTree() {
                ...
                #line 96 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
                System.Linq.Expressions.Expression<System.Func<System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport>>> expression = () => 
                        MyPortfolio;
            ...
            [System.Diagnostics.DebuggerHiddenAttribute()]
            public System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> @__Expr6Get() {
            ...
            public System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> ValueType___Expr6Get() {
                this.GetValueTypeValues();
                return this.@__Expr6Get();
            }
            
            [System.Diagnostics.DebuggerHiddenAttribute()]
            public void @__Expr6Set(System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> value) {
            ...
            public void ValueType___Expr6Set(System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> value) {
                this.GetValueTypeValues();
        ...
        private class ReportPortfolioActivity_TypedDataContext2_ForReadOnly : ReportPortfolioActivity_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 62 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
          ...
          IdFirma;
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 73 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
                System.Linq.Expressions.Expression<System.Func<System.Data.DataTable>> expression = () => 
                Business.DetalleInventario.ObtenerValoracionPortafolioClientesComercial(strIdComercial);
            ...
            internal System.Linq.Expressions.Expression @__Expr3GetTree() {
                ...
                #line 87 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
                System.Linq.Expressions.Expression<System.Func<System.Data.DataTable>> expression = () => 
                    Business.Instrumento.ObtenerComportamientoMercado(DateTime.Now , MyUser);
            ...
            internal System.Linq.Expressions.Expression @__Expr5GetTree() {
                ...
                #line 101 "C:\TFS\TRADINGSOLUTION\DATAIFX.TRADING.ACTIVITY\REPORTPORTFOLIOACTIVITY.XAML"
                System.Linq.Expressions.Expression<System.Func<System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport>>> expression = () => 
                        Business.DetalleInventario.FillPortfolioByTrader(dtMercado,dtPortfolio);
            ...
            [System.Diagnostics.DebuggerHiddenAttribute()]
            public System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> @__Expr5Get() {
            ...
            public System.Collections.Generic.List<Dataifx.Trading.Infrastructure.Models.PortfolioReport> ValueType___Expr5Get() {
                this.GetValueTypeValues();
