...
namespace Dataifx.Trading.Activity {
    ...
    public partial class AccountDemoActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.InOutArgument<Dataifx.Trading.Infrastructure.Models.DemoAccount> _demoAccount;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InOutArgument<Dataifx.Trading.Infrastructure.Models.DemoAccount> demoAccount {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AccountDemoActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AccountDemoActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(AccountDemoActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AccountDemoActivity.g.xaml") || resource.Equals("AccountDemoActivity.g.xaml"))) {
                    return resource;
                }
            }
