...
namespace Application.Enterprise.Data
{
    public class AmarresDao_old2
    {
        ...
        public AmarresDao_old2(string dataBase)
        {
            ...
            try
            {
                ...
                */
                ...
                try
                {
                    ...
                    objAuditoriaInfo.FechaSistema = DateTime.Now;
                    objAuditoriaInfo.Usuario = usuario;
                    objAuditoriaInfo.Proceso = "Se realizó creación de un Amarre.  Id_regla:" + item.Codigo2 + ",   Plu: " + item.Codigo2 + ",  Referencia: " + item.Codigo2+". Acción Realizada por el Usuario: " + usuario;
